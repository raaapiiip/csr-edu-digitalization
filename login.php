...
<html lang="en">
  ...
  <head>
    <title>SLB Kartini - Online Grading System</title>
    <meta charset="utf-8">
    ...
    <div class="container">
        <div class="row align-items-center position-relative">
            <div class="col-3">
                <div class="site-logo">
                    <?php
                    $leftLogoFilePath = 'images/ykb.png'; // Path to your left logo
                    if (file_exists($leftLogoFilePath)) {
                        echo '<a href="' . WEB_ROOT . '"><img src="' . $leftLogoFilePath . '" alt="Left Logo" style="max-height: 50px;"></a>';
                    } else {
                        echo '<a href="' . WEB_ROOT . '">Left Logo Text</a>'; // Fallback text
                    }
                    ?>
                </div>
            </div>
            ...
            <div class="col-3 text-right">
                <div class="site-logo">
                    <?php
                    $rightLogoFilePath = 'images/ifx.png'; // Path to your right logo
                    if (file_exists($rightLogoFilePath)) {
                        echo '<a href="' . WEB_ROOT . '"><img src="' . $rightLogoFilePath . '" alt="Right Logo" style="max-height: 50px;"></a>';
                    } else {
                        echo '<a href="' . WEB_ROOT . '">Right Logo Text</a>'; // Fallback text
                    }
                    ?>
                </div>
            </div>
...
<div class="ftco-blocks-cover-1">
      <div class="ftco-cover-1 overlay" style="background-image: url('images/school2.jpg')">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-lg-5">
              <h1 class="line-bottom">SLB Kartini Batam Grading System</h1>
            </div>
      ...
      <div class="container">
        ...
        <div class="row pt-5 mt-5 text-center">
          <div class="col-md-12">
            ...
            Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Project by <i class="icon-heart text-danger" aria-hidden="true"></i> <a href="https://colorlib.com" target="_blank" >CSR Education Infineon Technologies Batam</a>
            <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
            </p>
            </div>
          </div>
